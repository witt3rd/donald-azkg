...
**[[agentic_production_studio]]** - Windows 11 desktop application (WinUI 3) for creating and managing agentic productions. Provides production project structure, agent configuration via markdown, creative oversight UI, and rendering pipeline orchestration. Assumes aspirational Windows.Agents platform for distributed multi-agent capabilities.
